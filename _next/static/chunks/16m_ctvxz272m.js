(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,93512,e=>{"use strict";var t=e.i(43476),a=e.i(68877),i=e.i(57688),r=e.i(22016),l=e.i(71645),n=e.i(54181),o=e.i(87314),s=e.i(28747),c=e.i(97630);let d=[{label:"All",value:"All"},{label:"Functional Probiotics",value:"Functional Probiotics"},{label:"Functional Nature’s food ingredients",value:"Nature-derived Ingredients"}],u=new Set(["med01","med02","nvp2106","nvp1702","nvp1703","nvp1704"]);e.s(["ProductIngredientExplorer",0,function({items:e,title:g,description:b,koTitle:h,koDescription:f}){let{language:v}=(0,n.useDevLanguage)(),[A,y]=(0,l.useState)("All"),[m,p]=(0,l.useState)("All"),x=(0,l.useMemo)(()=>"ko"===v?e.map(e=>(0,s.getKoreanIngredient)(e)):e,[e,v]),k=(0,l.useMemo)(()=>new Set(e.filter(e=>!!u.has(e.id)||[...e.origin??[],...e.evidenceTags,...e.healthClaims??[],...e.featurePoints??[]].some(e=>/個別認定型|개별인정|KFDA/.test(e))).map(e=>e.id)),[e]),j=(0,l.useMemo)(()=>d.map(e=>({...e,label:"ko"===v&&"All"!==e.value?s.devKoreanLabels.line[e.value]:"ko"===v?"전체":e.label})),[v]),C=(0,l.useMemo)(()=>{let e=new Set(["All"]);return x.forEach(t=>{("All"===A||t.line===A)&&e.add(t.category)}),e},[A,x]),L=(0,l.useMemo)(()=>["All",...Array.from(new Set(x.map(e=>e.category))).filter(e=>C.has(e))],[x,C]),N=C.has(m)?m:"All",S=(0,l.useMemo)(()=>x.filter(e=>{let t="All"===A||e.line===A,a="All"===N||e.category===N;return t&&a}),[A,x,N]);return(0,l.useEffect)(()=>{document.querySelectorAll("[data-ingredient-filter-root]").forEach(e=>{e instanceof HTMLElement&&(e.dataset.reactFilterReady="true")})},[]),(0,t.jsxs)("section",{className:"dh-ingredient-explorer","aria-label":"Ingredient detail index","data-fallback-category":"All","data-fallback-line":"All","data-ingredient-filter-root":!0,children:[(0,t.jsxs)("div",{className:"dh-explorer-head",children:[(0,t.jsx)("p",{className:"dh-detail-primary",children:"INGREDIENT INDEX"}),(0,t.jsx)("h2",{children:"ko"===v&&h?h:g}),(0,t.jsx)("p",{children:"ko"===v&&f?f:b})]}),(0,t.jsxs)("div",{className:"dh-filter-stack","aria-label":"Product filters",children:[(0,t.jsx)("div",{className:"dh-filter-row","aria-label":"Product line",children:j.map(e=>(0,t.jsx)("button",{"aria-pressed":A===e.value,className:A===e.value?"is-active":"","data-line-filter":e.value,onClick:()=>{y(e.value),p("All")},type:"button",children:e.label},e.value))}),(0,t.jsx)("div",{className:"dh-filter-row dh-filter-row-soft","aria-label":"Ingredient category",children:L.map(e=>(0,t.jsx)("button",{"aria-pressed":N===e,className:N===e?"is-active":"","data-category-filter":e,onClick:()=>p(e),type:"button",children:"ko"===v&&"All"===e?"전체":e},e))})]}),(0,t.jsx)("div",{className:"dh-ingredient-count","data-ingredient-count":!0,children:"ko"===v?`${S.length}개 소재`:`${S.length}素材`}),(0,t.jsx)("div",{className:"dh-ingredient-card-grid",children:S.map(e=>{let l;return(0,t.jsxs)(r.default,{className:"dh-ingredient-card","data-category":e.category,"data-ingredient-card":!0,"data-line":e.line,href:(l="Functional Probiotics"===e.line?"/products/microbiome-probiotics":"/products/nature-ingredients",`${l}/${e.id}`),children:[(0,t.jsx)(i.default,{alt:"","aria-hidden":"true",height:320,loading:"eager",src:(0,c.getIngredientCardImage)(e.image),width:480}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"dh-ingredient-card-badges",children:[(0,t.jsx)(o.IngredientLineBadge,{label:"Functional Probiotics"===e.line?"Functional Probiotics":"Functional Nature’s food ingredients",line:e.line}),k.has(e.id)?(0,t.jsx)("span",{className:"dh-recognition-chip",children:"ko"===v?"개별인정형":"個別認定型素材"}):null]}),(0,t.jsx)("h3",{children:e.name}),(0,t.jsx)("strong",{children:e.area}),(0,t.jsxs)("span",{className:"dh-ingredient-card-intake",children:[(0,t.jsx)("em",{children:"ko"===v?"1일 섭취 기준":"一日摂取目安"}),e.intake]}),(0,t.jsxs)("em",{className:"dh-ingredient-card-cta",children:["DETAIL",(0,t.jsx)(a.ArrowRight,{"aria-hidden":"true",size:12,strokeWidth:3})]})]})]},e.id)})}),(0,t.jsx)("script",{dangerouslySetInnerHTML:{__html:`
(() => {
