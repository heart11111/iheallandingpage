...
const visionItems = [
  {
    ...
    koBody: "Vision Beyond Functional Healthcare Solution’s. 한국의 소재 개발·제조 역량과 일본 시장의 사업 기회를 연결하는 신뢰 기준을 만듭니다.",
  },
  {
    title: "Mission",
    body: "Functional Probiotics、自然由来機能性素材、OEM/ODM、ブランド協業を一つの流れとして整理し、パートナーの製品化可能性を高めます。",
    koBody: "Our Mission. 일본 기능성 헬스케어 산업에서 리딩 기업으로 도약하기 위해 Functional Probiotics line, Functional Nature‘s food ingredients Line, ODM/OEM & Brand Royalty를 하나의 흐름으로 정리합니다.",
  },
  {
    title: "Goal",
      ...
      <main>
        ...
        <section className="dh-sitemap-section">
          <div className="dh-container">
            ...
            <h1>
              <LocalizedText ja="Beyond Functional Healthcare Solutions" ko="Vision Beyond Functional Healthcare Solution’s" />
            </h1>
            <p className="dh-lead-copy">
              <LocalizedText
                ...
                ko="BIOLAB Japan은 기능성 식품 소재 사업, ODM/OEM & Brand Royalty, 일본 B2B 유통을 연결해 일본 기능성 헬스케어 산업의 리딩 기업으로 도약하는 것을 목표로 합니다."
              />
            </p>
