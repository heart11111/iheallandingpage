              ...
              <div>
                ...
                <p>
                  <LocalizedText
                    ...
                    ko="비오랩 재팬은 한국에 본사를 두고 있는 (주)비오랩의 일본 현지법인 입니다. (주)비오랩은 2017년 창립 이래 인류의 건강한 행복을 위해 마이크로바이옴 분야의 건강기능식품 헬스케어 전문 기업으로서 끊임없는 혁신과 노력을 통해 지속적인 성장을 해오고 있는 전문기업 입니다."
                  />
                </p>
                <p>
                  <LocalizedText
                    ...
                    ko="현재 가장 어렵고 진입 장벽이 높은 일본시장에서 당사의 iHEAL 브랜드는 전문 프로바이오틱스 영역에서 빛나는 성장을 거듭하고 있으며, 현재 다양한 기능성 건강식품 시장으로의 영역을 구축하고 있습니다. 비오랩 재팬이 공급하는 모든 기능성 소재는 인체시험과 SCI 국제학술논문, 관련 특허를 기반으로 하는 가장 안전하고 효과를 입증하는 소재들 입니다."
                  />
                </p>
                <p>
                  <LocalizedText
                    ...
                    ko="아울러 한국의 선진 제조기업들과의 완벽한 협업과 GMP 제조 시스템으로 생산되는 완벽한 제품들을 공급하고 있습니다. 우리는 이제 그 동안 쌓아 올린 노하우와 경험을 토대로 하여 일본 고객들의 Needs에 부합하는 당사만의 Total Healthcare Solution을 기반으로 하는 다양한 기능성 식품 소재 전문기업으로서 고객들의 든든한 파트너가 되겠습니다."
                  />
                </p>
              </div>
            </div>
