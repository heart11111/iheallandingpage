...
const lines = [
  {
    ...
    koCopy: "여성, 체지방, 인지, 간, 코, 스트레스, 장 용도에 맞춘 프로바이오틱스 소재를 검토합니다.",
  ...
  },
  {
    ...
    copy: "男性健康、記憶、認知、体脂肪、肌、肝・血糖、二日酔い、免疫などの自然由来機能性素材を提案します。モロシル、発酵紅参、ジンセンベリーなど、韓国の幅広い機能性素材ネットワークへのアクセスもご相談いただけます。",
    koCopy: "남성 건강, 기억, 인지, 체지방, 피부, 간·혈당, 숙취, 면역 등의 자연 유래 기능성 소재를 제안합니다. 모로오렌지추출분말(Morosil®), 발효홍삼, 진생베리 등 한국 기능성 소재 네트워크도 상담 가능합니다.",
