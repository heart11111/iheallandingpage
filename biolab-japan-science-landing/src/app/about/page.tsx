...
const aboutBlocks = [
  {
    ...
    koCopy:
      "Beyond Functional Healthcare Solutions. BIOLAB Japan은 기능성 소재의 근거 정보를 시작점으로 일본 시장에서 전개 가능한 헬스케어 사업을 설계합니다.",
  },
  {
    label: "Mission",
    copy:
              ...
              <div>
                ...
                <p>
                  <LocalizedText
                    ...
                    ko="비오랩 재팬은 한국에 본사를 둔 (주)비오랩의 일본 현지법인입니다. (주)비오랩은 2017년 창립 이래 마이크로바이옴 분야의 건강기능식품·헬스케어 전문 기업으로 성장해 왔습니다."
                  />
                </p>
                <p>
                  <LocalizedText
                    ...
                    ko="당사의 iHEAL 브랜드는 일본시장에서 전문 프로바이오틱스 영역을 중심으로 성장하고 있으며, BIOLAB Japan이 공급하는 기능성 소재는 인체적용시험, SCI 국제학술논문, 관련 특허를 기반으로 검토된 소재입니다."
                  />
                </p>
                <p>
                  <LocalizedText
