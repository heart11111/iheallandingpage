...
export const koreanIngredientCopy: Record<string, KoreanIngredientCopy> = {
  med01: {
    name: "iHEAL GINO 5 Formula – MED 01",
    category: "여성",
    area: "여성 질건강",
  ...
  med02: {
    ...
    category: "체지방",
    area: "체지방 감소",
    summary: "지방 세포 분화 억제를 위한 특허 프로바이오틱스 복합물이며, 항비만 특허 유산균입니다.",
    healthClaims: ["지방 세포 분화 억제를 위한 특허 프로바이오틱스 복합물", "100명의 인체시험 완료 및 SCI 논문으로 검증 된 항비만 특허 유산균", "체지방량, 체지방률, 체질량(BMI 지수)의 대폭 감소"],
    featurePoints: ["어린이 시기의 지방세포 분화 억제를 통한 소아비만 감소", "성인 시기의 중성지방 축적에 의한 비만 및 이상지질혈증 발생 위험 감소", "체질량지수(BMI) 감소"],
    evidenceTags: ["100명의 인체시험 완료", "SCI 논문", "BMI 감소"],
  },
  nvp2106: {
    name: "NVP-2106",
    category: "뇌·기억",
  ...
  nvp1702: {
    ...
    healthClaims: ["듀오바이옴 기술의 “간 기능 개선용” 2종 특허 프로바이오틱스 복합물", "93명의 인체시험 완료와 SCI 논문으로 검증 된 간기능 개선용 특허 유산균", "알콜성, 비알콜성 손상된 간 개선용 특허 프로바이오틱스 복합물"],
    featurePoints: ["체내 간 해독 기능 강화", "장내 내독소 및 혈중 내독소 개선", "비알콜성 간손상 및 알콜성 간손상 지표 개선"],
    evidenceTags: ["93명의 인체시험 완료", "SCI 논문", "ALT/AST/yGTP"],
  },
  nvp1703: {
    category: "코",
    name: "NVP-1703",
    ...
    featurePoints: ["소아·청소년: TNSS(전체 코증상 점수)의 유의적 개선", "소아·청소년: 비염 개선, 염증 조절 사이토카인 IL-10·IL-22 유의적 개선", "성인: TNSS(전체 코증상 점수), 수양성 콧물, 코막힘 개선", "성인: 비염증상 개선, 면역글로불린 IgE 감소"],
  ...
  immulink: {
    ...
    featurePoints: [
      ...
      "영지버섯균사체 추출분말",
      "고함량의 베타글루칸(77% 이상)",
      "구조적 특징: β-1,3 및 β-1,6 짧은 사슬과 Acetylation 등 복잡한 사슬 구조",
      "열 안정성(~261°C), pH 안정성(pH1-11), 무미, 무취",
      "한국, 미국(FDA GRAS), 유럽(EFSA), 대만, 중국, 말레이시아, 태국, 멕시코 등재",
      "유기농 인증, Non-GMO, 글루텐 프리, 코셔(Kosher), 할랄(HALAL) 인증",
      "적응(후천)면역력 개선: 총 림프구 수, T림프구(CD3+), 보조 T림프구(CD4+), 세포독성 T림프구(CD8+), CD4/CD8 비율, 혈청 IgA 글로불린 농도 증가",
      "선천면역력 개선: NK cell 수 증가, NK cell 활성 증가",
    ],
    evidenceTags: ["베타글루칸 77% 이상", "선천 면역", "후천 면역"],
    origin: ["영지균사체 추출분말"],
  },
};
