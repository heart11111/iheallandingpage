...
export const corporateNews = [
  {
    slug: "etnews-20260626",
    date: "2026.06.26",
    region: "KR",
    outlet: "電子新聞(etnews)",
    koOutlet: "전자신문",
    title: "電子新聞にBIOLAB関連記事が掲載されました",
    koTitle: "전자신문에 BIOLAB 관련 기사가 게재되었습니다",
    summary: "韓国の産業紙・電子新聞に掲載された記事です。全文は掲載元でご覧いただけます。",
    koSummary: "한국 산업지 전자신문에 게재된 기사입니다. 전문은 기사 원문에서 확인하실 수 있습니다.",
    href: "https://www.etnews.com/20260626000187",
  },
  {
    slug: "nikkei-tdnet-20260618",
    date: "2026.06.18",
    region: "JP",
    outlet: "日本経済新聞(適時開示)",
    koOutlet: "닛케이(적시공시)",
  ...
  {
    slug: "dbr-donga-kfocus",
    date: "2026",
    region: "KR",
    outlet: "東亜ビジネスレビュー(DBR)",
    koOutlet: "동아일보 DBR",
    title: "東亜ビジネスレビュー Korea Focusに掲載されました",
    koTitle: "동아비즈니스리뷰(DBR) 코리아 포커스에 게재되었습니다",
    summary: "東亜日報系のビジネス誌DBRのKorea Focusコーナーに掲載された記事です。",
    koSummary: "동아일보 계열 비즈니스 매거진 DBR의 코리아 포커스 코너에 게재된 기사입니다.",
    href: "https://dbr.donga.com/kfocus/view/article_no/3023",
  },
];
